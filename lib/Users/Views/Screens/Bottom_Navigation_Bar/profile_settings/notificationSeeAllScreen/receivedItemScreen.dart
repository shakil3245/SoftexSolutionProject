...
class ReceivedItemScreen extends StatefulWidget {
  const ReceivedItemScreen({Key? key}) : super(key: key);

  @override
  State<ReceivedItemScreen> createState() => _ReceivedItemScreenState();
}

class _ReceivedItemScreenState extends State<ReceivedItemScreen> {
  @override
