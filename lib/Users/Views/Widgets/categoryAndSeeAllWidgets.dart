...
class CategoryAndSeeAllWidgets extends StatelessWidget {
  const CategoryAndSeeAllWidgets({
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        Text(categoryName,style: TextStyle(fontSize: 16.sp,fontWeight: FontWeight.bold,color: Colors.white),),
        InkWell(
          onTap: onTap,
          child: Row(
            children: [
