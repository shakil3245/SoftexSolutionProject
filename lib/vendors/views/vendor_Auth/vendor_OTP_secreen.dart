import 'package:ecommerchapp/vendors/views/vendor_Auth/vendor_Login_Registration_Screen.dart';
...
class VendorRegistrationOTPScreen extends StatefulWidget {
  const VendorRegistrationOTPScreen({Key? key}) : super(key: key);

  @override
  State<VendorRegistrationOTPScreen> createState() => _VendorRegistrationOTPScreenState();
}

class _VendorRegistrationOTPScreenState extends State<VendorRegistrationOTPScreen> {
  @override
              ...
              child: Column(children: [
                ...
                Padding(
                  ...
                  child: ButtonWidgets(btnName: 'Verify', onTap: () {
                     Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Vendor_LoginScreenAndRegistration()));
                  },),
                ),
